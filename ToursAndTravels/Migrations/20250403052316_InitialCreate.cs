    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverSalaries", x => x.SalaryId);
                    table.ForeignKey(
                        name: "FK_DriverSalaries_Drivers_DriverId",
                        column: x => x.DriverId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoadingCharges = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PoliceEntryFee = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripExpenses", x => x.ExpenseID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DriverSalaries_DriverId",
                table: "DriverSalaries",
                column: "DriverId");
